...
This directory supports the Biupiu NFT / computational-art portfolio and linked personal R&D streams.

## Master architecture

**`BIUPIU-DEPARTMENT-INDEX.md` is the master department map.** It integrates the research portfolio into biotechnology, regenerative agriculture, industrial hemp, advanced materials, energy, photonics, aerospace/marine, computation, AI, robotics/automation, biomedical, geospatial/ancient-technology, IP and NFT/generative-art departments.
...
- **BIOCARBON / BIOCHEM** — carbon materials, biochar, activated carbon, pyrolysis and biomass fractionation
...
- **WATER** — hydrology, filtration, irrigation and water-energy systems
- **ENERGY / ELECTROMAG** — turbines, generators, storage, electrical and electromagnetic systems
- **PHOTONICS / PH-QPM / CRM** — photonics, holography, quantitative phase, crystals and quantum/photonic materials
- **METAMATERIALS** — metamaterials and metasurfaces across EM, optical, acoustic and mechanical systems
- **AERO / MARINE** — public-source aerospace, aerodynamics, marine and hydrodynamic engineering
- **COMPUTE / AI / GEOMETRY / DIGITAL-TWIN** — computational engineering, AI/ML, parametric geometry and digital-twin workflows
- **ROBOTICS / ADV-MFG** — automation, robotics, machine vision, advanced/additive manufacturing
- **BIOMED** — biomedical and life-science technology research
- **GEOARCH / LAND-GIS / ALA / AAT** — geoarchaeology, historical GIS, Ancient Landscape Atlas and Ancient Applied Technology
- **GEO-MAG / NAGA-HIM / SPEC** — geomagnetics, Naga/Himalayan research and controlled speculative-source analysis
- **IP / NFT-ART / NFT-PROV** — patents/prior art, generative artwork and digital provenance
