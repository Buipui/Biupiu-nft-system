...
export interface RenderJob { sourceAssetIds:string[]; provider:RenderProvider; output:"STILL"|"VIDEO"|"AUDIO"|"SHOWREEL"; provenanceRequired:true; parameters:Record<string,unknown>; }
